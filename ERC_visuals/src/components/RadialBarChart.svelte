<script>
  ...
  import { currentYear, budgetByGrantType, dataByYear, maxBudget } from '../stores';
  ...
  const x = d3.scaleBand()
    ...
    .domain([0, $maxBudget]) // Use the maxBudget value as the upper bound
